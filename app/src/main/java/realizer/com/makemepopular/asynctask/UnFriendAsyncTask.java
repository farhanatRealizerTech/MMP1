 ...
 */
public class UnFriendAsyncTask extends AsyncTask<Void,Void,StringBuilder> {
    ...
    public UnFriendAsyncTask(String frndid,Context mycontext, OnTaskCompleted cb) {
    ...
    protected StringBuilder doInBackground(Void... params) {
        ...
        String url= Config.URL_Mmp+"Unfriend";
