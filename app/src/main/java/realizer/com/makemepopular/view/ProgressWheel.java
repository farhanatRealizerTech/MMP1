...
//===============================================================================
package realizer.com.makemepopular.view;
...
public class ProgressWheel extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSpinning) {
            ...
            if (mProgress > 360) {
                ...
                // do something, like changing the backColor
                runCallback(-1.0f);
            }
    ...
    /**
     * @return the backColor of the spinning bar
     */
    ...
    /**
     * Sets the backColor of the spinning bar
     *
     * @param barColor The spinning bar backColor
     */
    ...
    /**
     * @return the backColor of the wheel's contour
     */
    ...
    /**
     * Sets the backColor of the wheel's contour
     *
     * @param rimColor the backColor for the wheel
     */
